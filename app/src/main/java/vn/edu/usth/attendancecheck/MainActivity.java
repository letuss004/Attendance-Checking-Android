...
import vn.edu.usth.attendancecheck.ui.*;
...
public class MainActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
        ...
        navigationView.setOnItemSelectedListener(
                item -> {
                    ...
                    if (id == R.id.navIcon_checkList) {
                        ...
                        switchFragment(new UserMenuFragment());
                    }
                    return true;
                }
        );
    ...
    private void openCameraRequirePermission() {
        ...
        if (EasyPermissions.hasPermissions(this, perm)) {
            ...
            EasyPermissions.requestPermissions(this, "Need permission because of something", 123, perm);
        }
    }
